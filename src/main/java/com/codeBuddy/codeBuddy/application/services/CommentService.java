...
public class CommentService {
    ...
    @Autowired
    public CommentService(CommentRepository commentRepository, @Lazy StudentService studentService, @Lazy MentorService mentorService, PostService postService, MentorRepository mentorRepository, StudentRepository studentRepository) {
